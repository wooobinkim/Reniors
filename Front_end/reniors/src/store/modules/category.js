...
export default{
    ...
    actions: {
        ...
        getJobChild:({commit},no)=>{
            http.get(`/categories/parent/${no}/child`)
            .then(({data})=>{
        ...
        getGugun:({commit},no)=>{
            http.get(`/categories/sido/${no}/gugun`)
            .then(({data})=>{
